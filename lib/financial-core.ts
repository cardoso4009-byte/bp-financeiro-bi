...
// Fluxo de caixa operacional é separado de CAPEX para evitar dupla contagem.
const operatingCashIn=[63000,67500,72000,70200,73800,76500,79200,81000,82800,85000,87000,90000]

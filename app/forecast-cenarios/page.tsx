...
export default function ForecastCenarios(){
 ...
 return <main className="content" style={{marginLeft:0,width:'100%',maxWidth:1450,margin:'0 auto'}}><header><div><small>CONTROLADORIA FINANCEIRA</small><h1>Forecast por Cenários</h1><p>Base • Otimista • Pessimista — impacto financeiro antes da decisão</p></div></header>
 <section className="panel wide"><ReportPeriodFilter value={period} onChange={setPeriod} years={[2025,2026]}/><div className="filters" style={{marginTop:12}}><label>Data-base <input type="date" value={asOf} onChange={e=>setAsOf(e.target.value)}/></label><span className="note">O período define a competência analisada; a data-base separa realizado e forecast.</span></div></section>

...
export default function Rentabilidade(){
 ...
 const nodes=useMemo(()=>buildFinancialDrilldown(scoped),[scoped])
 ...
 const previous=operational.filter(e=>e.competence===previousKey)
 ...
 return <main className="content" style={{marginLeft:0,width:'100%',maxWidth:1500,margin:'0 auto'}}>
  <header><div><small>CONTROLADORIA FINANCEIRA</small><h1>Rentabilidade Gerencial</h1><p>Receita • OPEX • Resultado • Margem • Conta • Centro de custo • Categoria</p></div><ReportPeriodFilter value={period} onChange={p=>{setPeriod(p);setExpanded(new Set());setSelected(null)}} years={[2026]}/></header>

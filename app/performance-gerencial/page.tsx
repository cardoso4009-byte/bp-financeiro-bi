...
export default function PerformanceGerencial(){
 ...
 return <main className="content" style={{marginLeft:0,width:'100%',maxWidth:1450,margin:'0 auto'}}>
  <header><div><small>CONTROLADORIA FINANCEIRA</small><h1>Performance Gerencial</h1><p>Orçado → Realizado → Forecast → Desvio → Ação → Impacto</p></div><ReportPeriodFilter value={period} onChange={setPeriod} years={[2026]}/></header>

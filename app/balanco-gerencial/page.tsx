...
export default function BalancoGerencial(){
 const[period,setPeriod]=useState<ReportPeriod>({...DEFAULT_REPORT_PERIOD,year:availableYears[0]??2026,month:1})
 ...
 const prev=monthlyBalance[Math.max(0,baseIndex-1)]
 ...
 const viewLabel=period.view==='acumulado'?'Posição até o mês selecionado':period.view==='comparativo'?'Comparação com período anterior':'Posição do mês'

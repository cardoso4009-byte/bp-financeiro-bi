...
export default function BalancoGerencial(){
 ...
 const prev=monthlyBalance[Math.max(0,prevIndex)] ?? monthlyBalance[Math.max(0,baseIndex-1)]
 ...
 const viewLabel=period.view==='acumulado'?'Posição acumulada até o mês selecionado':period.view==='comparativo'?'Comparativo com o período anterior':'Posição patrimonial do mês selecionado'

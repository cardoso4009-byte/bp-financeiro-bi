...
function Executive(){
  ...
  return <>
    ...
    <Panel title="Leitura gerencial"><div className="note">O modelo demonstra lucro líquido de R$ 120 mil, geração operacional de caixa de R$ 120 mil e caixa final de R$ 100 mil. Agora o BI já possui uma camada mensal reconciliada ao modelo anual, preparando Orçado x Realizado, capital de giro e alertas.</div></Panel>
  </>
}

...
export default function CenariosForecastV2(){
 ...
 return <main className="page bp-view">
  <style>{`.page{max-width:1250px;margin:auto;padding:28px;font-family:Arial,sans-serif;color:#172033;background:#f4f7fb;min-height:100vh}.head{display:flex;justify-content:space-between;gap:20px;align-items:flex-start;margin-bottom:20px}.eyebrow{font-size:11px;color:#718098;font-weight:800;letter-spacing:.1em}.head h1{margin:6px 0;font-size:30px}.head p{margin:0;color:#718098}.filter{background:#fff;border:1px solid #e2e7ed;border-radius:12px;padding:10px 14px}.tabs{display:flex;gap:8px;margin-bottom:14px}.tab{border:1px solid #d4e0eb;background:#fff;border-radius:9px;padding:10px 16px;font-weight:800;cursor:pointer}.tab.active{background:#17304a;color:#fff}.cards{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:14px}.card,.panel{background:#fff;border:1px solid #e2e7ed;border-radius:14px}.card{padding:17px}.card span{display:block;color:#718098;font-size:12px}.card strong{display:block;font-size:23px;margin-top:7px}.card small{display:block;margin-top:5px;color:#8094a8}.panel{padding:20px;margin-bottom:14px}.panel h2{margin:0;font-size:17px}.title{display:flex;justify-content:space-between;align-items:center;margin-bottom:15px}.title span{font-size:11px;color:#7b8fa4}.note{padding:13px;border-radius:10px;background:#f5f8fb;border:1px solid #e4ebf2;color:#536b80;font-size:12px;line-height:1.5}.table{width:100%;border-collapse:collapse;font-size:12px}.table th,.table td{padding:10px;border-bottom:1px solid #edf1f5;text-align:right}.table th:first-child,.table td:first-child{text-align:left}.positive{font-weight:800}@media(max-width:800px){.cards{grid-template-columns:1fr 1fr}.head{flex-direction:column}}@media(max-width:520px){.cards{grid-template-columns:1fr}.tabs{flex-wrap:wrap}}`}</style>

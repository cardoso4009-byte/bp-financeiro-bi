...
export default function ExecutiveCockpit(){
 ...
 const previous=useMemo(()=>monthIndex>0?buildExecutiveCockpit(previousIndex,gerencial,'mensal'):null,[monthIndex,previousIndex,gerencial])

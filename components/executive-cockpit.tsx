...
export default function ExecutiveCockpit(){
 ...
 return <section className="executive-cockpit">
  <style>{`
   ...
   .cockpit-controls{display:flex;align-items:center;gap:9px}
   .cockpit-controls select{background:#102b46;color:#fff;border:1px solid #3b5c78;border-radius:9px;padding:9px 12px;font-size:11px;min-width:100px;outline:none}
   .cockpit-controls select:focus{border-color:#69baff}
   ...
   @media(max-width:760px){.executive-cockpit{padding:16px}.cockpit-head{display:block}.cockpit-controls{margin-top:12px;flex-wrap:wrap}.cockpit-controls select{flex:1}.cockpit-status{flex:1;text-align:center}.cockpit-body{grid-template-columns:1fr}.cockpit-kpis{grid-template-columns:repeat(2,1fr)}}
  `}</style>

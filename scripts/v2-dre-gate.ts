...
if (p.receita !== 10000 || p.custos !== -3000 || p.opex !== -2000 || p.ebitda !== 5000 || p.resultadoFinanceiro !== -500 || p.impostos !== -700 || p.resultadoLiquido !== 3800) {
  throw new Error('Falha nos cálculos da DRE V2')
}

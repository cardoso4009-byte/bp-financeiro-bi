...
assert.equal(audit.dreVsDfc.dreResult,1460)
assert.equal(audit.dreVsDfc.cashVariation,1200)
assert.equal(audit.dreVsDfc.bridgeDifference,-260)
assert.equal(audit.periodVariation.dreResultVariation,1460)
